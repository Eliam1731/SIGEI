...
<form id="form-equipment">
    ...
    <div class='containerInput__flex'>
        ...
        <input type="date" id="dateBuy" required>
    </div>

    <div class='containerInput__flex'>
        <label for="dateExpiresWarranty">Fecha en la que expira la garantía</label>

        <input type="date" id="dateExpiresWarranty" required>
    </div>
    ...
    <div class='containerInput__flex'>
        ...
        <input id="referenceCompaq" type="text" placeholder="Ejemplo: 012832903" required>
    </div>
    ...
    <div class='containerInput__flex'>
        ...
        <div class="container__inputfile">
            <input id="invoiceDevices" type="file" accept=".pdf,.xml" multiple required>
    ...
    <div class='containerInput__flex'>
        ...
        <div class="container__inputfile">
            ...
            <label for="imageDevices">
                ...
                <span>No hay imagenes seleccionadas</span>
            </label>
        </div>
    </div>
