...
export const windowDeviceInformation = (data) => {
    const stringEmpty = /^\s*$/;
    ...
    <div class='container-info__device'>
        <dl>
            ...
            <div class='row-info__device'>
                ...
                <dd>${data.fecha_compra}</dd>
            </div>

            <div class='row-info__device'>
                <dt>Fecha en la que expira la garantía</dt>
                <dd>${data.fecha_garantia}</dd>
            </div>
            ...
            <div class='row-info__device'>
                ...
                <dd>${data.n_referencia_compras}</dd>
            </div>

            <div class='row-info__device'>
                <dt>Dirección MAC Ethernet</dt>
                <dd>${(data.mac_ethernet === '') ? 'El equipo no cuenta con una dirección MAC Ethernet' : data.mac_ethernet}</dd>
            </div>

            <div class='row-info__device'>
                <dt>Dirección MAC Wi-Fi</dt>
                <dd>${(data.mac_wifi === '' ? 'El equipo no cuenta con una dirección MAC Wi-Fi' : data.mac_wifi)}</dd>
            </div>
