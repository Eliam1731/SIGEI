...
if (empty($num_telefono)) {
    $response = ['status' => 'error', 'message' => 'Por favor, ingrese un número de teléfono.'];
...
$sql = $conn->prepare("SELECT 
        ...
        equipos_informaticos.num_telefono AS num_telefono,
    ...
    WHERE equipos_informaticos.num_telefono = ?");
$sql->execute([$num_telefono]);
