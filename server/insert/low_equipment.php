...
try {
    ...
    // Reorganiza la fecha
    $fecha_baja_reorganizada = substr($fecha_baja, 0, 4) . '-' . substr($fecha_baja, 4, 2) . '-' . substr($fecha_baja, 6, 2);

    // Formatea la fecha
    $fecha_baja_formateada = date('Y-m-d', strtotime($fecha_baja_reorganizada));
